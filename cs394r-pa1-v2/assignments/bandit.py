...
class SampleAverageMethod(ActionValue):
    ...
    def update(self, a: int, r: float):
        ...
        self.n[a] += 1
        # Sample-average method: Q_n+1 = Q_n + (1/n) * (R_n - Q_n)
        # This is the incremental implementation of the sample average
...
class ConstantStepSizeMethod(ActionValue):
    ...
    def update(self, a: int, r: float) -> None:
        ...
        # Constant step-size method: Q_n+1 = Q_n + alpha * (R_n - Q_n)
        # This gives more weight to recent rewards, making it suitable for non-stationary environments
