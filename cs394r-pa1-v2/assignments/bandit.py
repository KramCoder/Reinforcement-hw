...
class SampleAverageMethod(ActionValue):
    ...
    def update(self, a: int, r: float):
        ...
        # Update Q value using incremental sample-average formula (equation 2.3)
        # Q_n+1(a) = Q_n(a) + 1/n * (R_n - Q_n(a))
...
class ConstantStepSizeMethod(ActionValue):
    ...
    def update(self, a: int, r: float) -> None:
        ...
        # Update Q value using constant step-size formula (equation 2.5)
        # Q_n+1(a) = Q_n(a) + alpha * (R_n - Q_n(a))
...
class BanditSolver(Solver):
    ...
    def train_episode(self):
        ...
        while not done and not truncated:
            ...
            # 2. Step the environment with the selected action
            next_state, r, done, truncated, info = env.step(a)
            
            # 3. Update the Q value using the method (sample-average or constant step-size)
            method.update(a, r)
