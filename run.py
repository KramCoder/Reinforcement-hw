...
def main():
    ...
    parser_bandits.add_argument('--epsilon', type=float, required=False, default=0.1, help="Epsilon value for epsilon-greedy policy")
    parser_bandits.add_argument('--alpha', type=float, required=False, default=0.1, help="Alpha value for constant step-size method")
